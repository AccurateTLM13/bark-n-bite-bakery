  ...
  <footer id="contact" className="bg-brown-900 text-white py-16">
    <div className="max-w-7xl mx-auto px-6 lg:px-8">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
        <div>
          <div className="text-xl sm:text-2xl font-bold mb-4 font-serif">Bark & Bite Bakery</div>
          <p className="text-brown-300 mb-4 sm:mb-6 text-sm sm:text-base">Handcrafted treats made with love for your furry family members.</p>
        ...
        <div>
          <h5 className="text-base sm:text-lg font-semibold mb-4 font-serif">Quick Links</h5>
        ...
        <div>
          <h5 className="text-base sm:text-lg font-semibold mb-4 font-serif">Contact Info</h5>
        ...
        <div>
          <h5 className="text-base sm:text-lg font-semibold mb-4 font-serif">Pickup Hours</h5>
          <div className="space-y-2 text-brown-300 text-sm sm:text-base">
            <p>{pickupHours}</p>
            <p>{orderClose}</p>
      ...
      <div className="border-t border-brown-800 mt-12 pt-8 text-center">
        <p className="text-brown-300 text-sm sm:text-base">© 2025 Bark & Bite Bakery. All rights reserved. Made with ❤️ for dogs and their humans.</p>
      </div>
    </div>
  </footer>
);
