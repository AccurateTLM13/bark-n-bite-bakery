      ...
      <div className="grid md:grid-cols-4 gap-8">
        <div>
          ...
          <div className="flex space-x-4">
            <a href="#" className="text-brown-300 hover:text-white transition-colors"><Facebook className="h-6 w-6" /></a>
            <a href="#" className="text-brown-300 hover:text-white transition-colors"><Instagram className="h-6 w-6" /></a>
            <a href="#" className="text-brown-300 hover:text-white transition-colors"><Twitter className="h-6 w-6" /></a>
          </div>
        </div>
        <div>
        ...
        <div>
          ...
          <div className="space-y-3">
            <div className="flex items-center space-x-3"><Phone className="h-4 w-4 text-brown-400" /><span className="text-brown-300">(731) 555-BARK</span></div>
            <div className="flex items-center space-x-3"><Mail className="h-4 w-4 text-brown-400" /><span className="text-brown-300">hello@barkandbite.com</span></div>
            <div className="flex items-center space-x-3"><MapPin className="h-4 w-4 text-brown-400" /><span className="text-brown-300">Gibson County, TN</span></div>
          </div>
        </div>
        <div>
